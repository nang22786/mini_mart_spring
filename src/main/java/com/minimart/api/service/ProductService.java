    ...
    public Product updateProduct(Integer id, Product productDetails, Integer stockQty) {
        ...
        if (oldImage != null && !oldImage.isEmpty() &&
            ...
            try {
                ...
                System.out.println("✅ Old product image deleted from Cloudinary: " + oldImage);
            } catch (Exception e) {
                System.err.println("⚠️ Failed to delete old product image: " + e.getMessage());
            }
        }
    ...
    public void deleteProduct(Integer id) {
        ...
        if (product.getImage() != null && !product.getImage().isEmpty()) {
            try {
                ...
                System.out.println("✅ Product image deleted from Cloudinary: " + product.getImage());
            } catch (Exception e) {
